...
<div class="sidebar clearfix">
	<div role="tabpanel" class="sidepanel" style="display: block;">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation" class="" style="width:25%;">
				<a href="#tab-04" aria-controls="tab-04" role="tab" data-toggle="tab" class="" aria-expanded="false">
					<i class="fas fa-check-square"></i><br>성능평가
				</a>
			</li>
			<li role="presentation" class="active" style="width:25%;">
				<a href="#tab-05" aria-controls="tab-05" role="tab" data-toggle="tab" class="active" aria-expanded="true">
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane active" id="tab-05">
