		...
		<ul class="nav nav-tabs" role="tablist">
			<li role="presentation" class="active" style="width:50%;">
				<a href="#tab-01" aria-controls="tab-01" role="tab" data-toggle="tab" aria-expanded="true" class="active">
					<i class="fas fa-adjust"></i><br>변화탐지 요청
				</a>
			</li>
			<li role="presentation" class="" style="width:50%;">
				<a href="#tab-02" aria-controls="tab-02" role="tab" data-toggle="tab" class="" aria-expanded="false">
					<i class="fas fa-list"></i><br>처리 결과
				</a>
			</li>
		</ul>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="panel-body">	
										...
										<div class="col-sm-12">	
											<div class="form-group m-t-10">
												<label class="col-sm-3 control-label form-label">변화탐지 방법</label>
												<div class="col-sm-9">
													<select class="form-basic">
														<option></option>
													</select>
										...
										<div class="col-sm-12">	
											<div class="form-group m-t-10">
												<label class="col-sm-3 control-label form-label">분류 방법</label>
												<div class="col-sm-9">
													<select class="form-basic">
														<option></option>
													</select>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default"><i class="fas fa-adjust m-r-5"></i>추출 시작</button>
