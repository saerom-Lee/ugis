	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">자료 등록 실패 안내</h4>
			</div>
			<div class="modal-body">
				<div class="panel-body">	
					...
					<div class="form-group">
						<textarea class="form-control" rows="4" cols="50">LC_AP_36702057_002&#10;LC_AP_36702057_003&#10;(등록하지 못한 영상 ID 노출)</textarea>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default"><i class="fas fa-download m-r-5"></i>목록 다운로드</button>
			</div>
		</div>
	</div>
</div>
