...
<body>
		...
		<div role="tabpanel" class="sidepanel" style="display: block;">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active" style="width: 50%;"><a
					id="detctChange" href="#changeDetctModel"
					aria-controls="changeDetctModel" role="tab" data-toggle="tab"
					aria-expanded="true" class="active"> <i
						class="fas fa-plus-square"></i><br>변화탐지 요청
				</a></li>
				<li role="presentation" class="" style="width: 50%;"><a
					id="detctResult" href="#changeResultModel"
					aria-controls="changeResultModel" role="tab" data-toggle="tab"
					class="" aria-expanded="false"> <i class="fas fa-list"></i><br>처리
						결과
				</a></li>
			</ul>
			...
			<div class="tab-content">
				...
				<div id="changeDetctModel"
					...
					<div class="panel-body">
						...
						<div data-bind="with: form" id="changeDetctForm"
							...
							<div class="modal-dialog modal-sm">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title">변화 탐지 요청</h4>
									</div>
									<div class="modal-body">
										<div class="panel-body">
											<div class="sidepanel-m-title">알고리즘</div>
											<div class="col-sm-12">
												<div class="form-group m-t-10">
													<label class="col-sm-3 control-label form-label">변화탐지
														방법</label>
													<div class="col-sm-9">
														<select
															data-bind="options: chngeDetctAlgrthCdOptions, optionsValue: 'value', optionsText: 'text', value: chngeDetctAlgrthCd, valueAllowUnset: true, optionsCaption: ''"
															class="form-basic"></select>
													</div>
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group m-t-10">
													<label class="col-sm-3 control-label form-label">분류
														방법</label>
													<div class="col-sm-9">
														<select
															data-bind="options: classCdOptions, optionsValue: 'value', optionsText: 'text', value: classCd, valueAllowUnset: true, optionsCaption: '', disable: true"
															class="form-basic"></select>
													</div>
												</div>
											</div>
											<label class="col-sm-12 control-label form-label">영상
												목록 (총 <span data-bind="text: vidoList().length"></span>개)
											</label>
											<div class="col-sm-12">
											...
											<div class="col-sm-12">
												<div class="form-group m-t-10">
													<label class="col-sm-3 control-label form-label">기준
														영상</label>
													<div class="col-sm-9">
														<select
															data-bind="options: stdrVidoIdOptions, optionsValue: 'value', optionsText: 'text', value: stdrVidoId, valueAllowUnset: true, optionsCaption: ''"
															class="form-basic"></select>
													</div>
												</div>
											</div>
											<div class="col-sm-12">
												<div class="form-group m-t-10">
													<label class="col-sm-3 control-label form-label">CVA
														필터</label>
													<div class="col-sm-5" style="display: flex;">
														<input data-bind="numeric, value: cvaPt" type="text"
															class="form-control" maxlength="4"><label
															class="col-sm-1 control-label form-label">%</label>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="modal-footer">
										<button data-bind="click: $parent.saveData" type="button"
											class="btn btn-default">
											<i class="fas fa-adjust m-r-5"></i>변화탐지 시작
										</button>
				...
				<div id="changeResultModel" role="tabpanel" class="tab-pane">
						...
						<div class="modal-dialog modal-sm">
							<div class="modal-content" style="width: 320px;">
								<div class="modal-header">
									...
									<h4 class="modal-title">변화탐지 완료</h4>
								</div>
								<div class="modal-body">
									변화탐지가 완료 되었습니다.<br />처리 결과는 처리결과(Tab) 에 추가 됩니다.
								</div>
								<div class="modal-footer">
												...
												<div class="col-sm-12">
													...
													<div class="form-group m-t-10">
														...
														<div class="col-sm-9">
															...
															<input data-bind="value: chngeDetctResultId" name="chngeDetctResultId" type="hidden">
															<input data-bind="value: chngeDetctVidoResultId" name="chngeDetctVidoResultId" type="hidden">
														</div>
													</div>
												</div>
											</div>
	...
	<script type="text/javascript"
		src="${contextPath}/js/ci/cisc017/cmmn-module.js"></script>
	<script type="text/javascript"
		src="${contextPath}/js/ci/cisc017/change-detct-module.js"></script>
	<script type="text/javascript"
		src="${contextPath}/js/ci/cisc017/change-result-module.js"></script>
