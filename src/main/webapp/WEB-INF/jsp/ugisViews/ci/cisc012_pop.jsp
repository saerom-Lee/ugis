					...
					<div class="form-group m-t-10">
						...
						<div class="col-sm-6">
							<div class="radio radio-info radio-inline">
								...
								<label for="inlineRadio1">기존 파일 덮어쓰기</label>
							</div>
						</div>	
						<div class="col-sm-6">
							<div class="radio radio-info radio-inline">
								<input type="radio" id="inlineRadio2" value="" name="radioInline" checked="">
								<label for="inlineRadio2">다른 이름으로 저장</label>
							</div>
						</div>	
					</div> 
