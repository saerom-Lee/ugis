			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) { // 미리보기중인 자식노드만 제거
						...
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('ortho-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
				}
			} else { //미리보기 생성
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) { // 미리보기 상태가 아닌 경우
						...
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('ortho-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
				}
			}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('aerial-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					...
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('aerial-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('dem-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					...
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('dem-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById(tree[i].id.split('-')[2] + '-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp(tree[i].id.split('-')[2] + '-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('kompsat-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('kompsat-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('landsat-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('landsat-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('sentinel-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('sentinel-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('cas-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('cas-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('flood-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('flood-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('redTide-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('redTide-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('earthquake-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('earthquake-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('landslide-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('landslide-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('maritime-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('maritime-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('rasterAnalObj-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('rasterAnalObj-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
					}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('rasterAnalChg-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.updateImageLayerTemp('rasterAnalChg-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('vectorAnalObj-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							// CMSC003.GIS.updateImageLayerAnalysisRequest('vectorAnalObj-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
							var currentTab = getCurrentTab();
							var checked = null;
							if(currentTab === 1) {
								checked = $('input[name=dataTypeAbs]:checked').val();								
							} else {
								checked = $('input[name=dataType]:checked').val();
							}
							
							if(checked === '1') {
								CMSC003.GIS.updateImageLayerAnalysisRequest('vectorAnalObj-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);	
							} else if(checked === '2'){
								CMSC003.GIS.updateImageLayerAnalysisResult('vectorAnalObj-' + $(`#${tree[i].id}`).attr("value"), false, ciscMap.map);
							}
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById('vectorAnalChg-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							//CMSC003.GIS.updateImageLayerAnalysisRequest('vectorAnalChg-' + $(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
							...
							if(checked === '1') {
								...
								CMSC003.GIS.updateImageLayerAnalysisResult('vectorAnalChg-' + $(`#${tree[i].id}`).attr("value"), false, ciscMap.map);
							}
						}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				for (var i = 0; i < tree.length; i++) {
					if ($(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${tree[i].id}`).removeClass('ui-btn-clicked-layer-preview');
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							CMSC003.GIS.removeLayerById($(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
						}
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							// CMSC003.GIS.updateImageLayerFromGeoserver($(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
							var currentTab = getCurrentTab();
							var checked = null;
							if(currentTab === 1) {
								checked = $('input[name=dataTypeAbs]:checked').val();								
							...
							if(checked === '1') {
								...
								CMSC003.GIS.updateImageLayerAnalysisResult($(`#${tree[i].id}`).attr("value"), false, ciscMap.map);
							}
						}
					}
			...
			if ($(`#${id}`).hasClass('ui-btn-clicked-layer-preview')) { // 미리보기 제거
				...
				for (var i = 0; i < tree.length; i++) {
					if (!$(`#${tree[i].id}`).hasClass('ui-btn-clicked-layer-preview') && !$(`#${tree[i].id} > a > button`).is(":disabled")) {
						...
						$(`#${id}`).jstree()._model.data[tree[i].id].li_attr.class += ' ui-btn-clicked-layer-preview';
						if ($(`li#${tree[i].id}[class*="js-tree-child"]`).length) { // 최하위 자식인 경우
							// CMSC003.GIS.updateImageLayerFromGeoserverDemographic($(`#${tree[i].id}`).attr('value'), false, ciscMap.map);
							var currentTab = getCurrentTab();
							var checked = null;
							if(currentTab === 1) {
								checked = $('input[name=dataTypeAbs]:checked').val();								
