...
SHPParser.load = function(url, callback, returnData, instance) {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', url);
    xhr.responseType = 'arraybuffer';
    xhr.onload = function() {
        geojsonData['shp'] = new SHPParser().parse(xhr.response,url);
        callback(geojsonData['shp'], returnData, instance);
...
DBFParser.load = function(url, encoding, callback, returnData, instance) {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', url);
    xhr.responseType = 'arraybuffer';
    ...
    xhr.onload = function() {
        ...
        xhrText.onload = function() {
            ...
            callback(geojsonData['dbf'], returnData, instance);
            URL.revokeObjectURL(url);
        };
